...
public class FingerprintAuthActivity extends AppCompatActivity {
    ...
    private String KEY_NAME = Utilities.KEY_NAME;
                ...
                if (!fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    if (!keyguardManager.isKeyguardSecure()) {
                        ...
                        if (cipherInit()) {
                            ...
                            boolean l2 = getIntent().getBooleanExtra("level2", false);
                            if (l2) {
                                TextView t1 = findViewById(R.id.textView6);
                                t1.setText("Utilizza la tua impronta per confermare l'accesso al tuo wallet");
                                FingerprintHandler helper = new FingerprintHandler(this, 1, flag);
                                helper.startAuth(fingerprintManager, cryptoObject);
                            } else {
                                FingerprintHandler helper = new FingerprintHandler(this, state, flag);
                                helper.startAuth(fingerprintManager, cryptoObject);
                            }
